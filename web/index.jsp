            ...
            <div class="row mt-2">
                <div class="col-sm">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th scope="col" colspan="6" class="text-center">Estudiante</th>
                                <th scope="col">
                            ...
                            <tr>
                                ...
                                <th scope="col">Foto Bicicleta</th>
                        ...
                        <tbody>
                            <%
                                try {
                                    ...
                                    con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/jsps?user=root&password=");
                            ...
                            <tr>
                                ...
                                <td><img src=<%= rs.getString(6)%> alt"Image" width="250" height="250"></td>
                                <td><img src=<%= rs.getString(7)%> alt"Image" width="250" height="250"></td>
                                
                                
                                <td>
                                    <a href="editar.jsp?id=<%= rs.getString(1)%>&nombre=<%= rs.getString(2)%>&documento=<%= rs.getString(3)%>&telefono=<%= rs.getString(4)%>&serial=<%= rs.getString(5)%>"<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>                            
